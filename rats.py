...
as its argument ‘r’ represents the number of rats present in an area, ‘unit’ is the amount of food each rat consumes 
...
for i in range (0,len(arr)):
        total_food=total_food-arr[i]
        if total_food<0:
           break
print(abs(total_food))
